...
- GitHub: [https://github.com/laxcoin/laxcoin](https://github.com/laxcoin/laxcoin)
...
## Installing Laxcoin from a Package
...
* Arch Linux (via [AUR](https://aur.archlinux.org/)):
  - Stable release: [`laxcoin`](https://aur.archlinux.org/packages/laxcoin)
  - Bleeding edge: [`laxcoin-git`](https://aur.archlinux.org/packages/laxcoin-git)

* Docker

        docker build -t laxcoin .
     
        # either run in foreground
        docker run -it -v /laxcoin/chain:/root/.laxcoin -v /laxcoin/wallet:/wallet -p 26967:26967 laxcoin

        # or in background
        docker run -it -d -v /laxcoin/chain:/root/.laxcoin -v /laxcoin/wallet:/wallet -p 26967:26967 laxcoin

Packaging for your favorite distribution would be a welcome contribution!

## Compiling Laxcoin from Source
...
Laxcoin uses the CMake build system and a top-level [Makefile](Makefile) that
...
* Add `PATH="$PATH:$HOME/laxcoin/build/release/bin"` to `.profile`

* Run laxcoin with `laxcoind --detach`
...
To list all available options, run `./bin/laxcoind --help`.  Options can be
...
[laxcoind.service](utils/systemd/laxcoind.service) to `/etc/systemd/system/` and
[laxcoind.conf](utils/conf/laxcoind.conf) to `/etc/`. The [example
service](utils/systemd/laxcoind.service) assumes that the user `laxcoin` exists
and its home is the data directory specified in the [example
config](utils/conf/laxcoind.conf).
